...
def main():
    ...
    recterr1 = (x1-x0)/24*h1**2*(3/16) #(3/16) - max|f''(x)| for x from -1 to 1
    ...
    recterr2 = (x1-x0)/24*h2**2*(3/16) #(3/16) - max|f''(x)| for x from -1 to 1
    ...
    traperr1 = (x1-x0)/12*h1**2*(3/16) #(3/16) - max|f''(x)| for x from -1 to 1
    ...
    traperr2 = (x1-x0)/12*h2**2*(3/16) #(3/16) - max|f''(x)| for x from -1 to 1
    print("trapeze method(h=0.5):")
    print(trapres2)
    print("error:")
    print(traperr2)
    ...
    simerr1 = (x1-x0)/180*h1**4*(81/32) #(81/32) - max|f''''(x)| for x from -1 to 1
    ...
    simerr2 = (x1-x0)/180*h2**4*(81/32) #(81/32) - max|f''''(x)| for x from -1 to 1
    print("simson method(h=0.5):")
    print(simres2)
    print("error:")
    print(simerr2)
